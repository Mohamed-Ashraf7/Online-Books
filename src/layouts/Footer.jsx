...
const Footer = () => {
  return (
    <footer className="md:px-32 px-4 relative py-8 md:py-10 rounded-t-3xl bg-[#111] font-second flex-col  text-white ">
      <div className="container  flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
        <div className="centerd pr-3 space-x-4 sm:space-x-8">
          ...
          <ul className="centerd space-x-4 sm:space-x-8">
            <li className="text-2xl ">Terms of Use</li>
            <li className="text-2xl ">Privacy</li>
          </ul>
        </div>
