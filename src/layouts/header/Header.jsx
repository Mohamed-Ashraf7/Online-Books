...
function Header() {
  ...
  return (
    <nav className="bg-[#fff] backdrop-blur-lg bg-opacity-[.4]  px-10  rounded-[25px] w-[95%] xl:w-[70%]  fixed top-[2%] left-1/2 transform -translate-x-1/2 z-50  shadow-md shadow-black ">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between  mx-auto p-4">
        ...
        <div
          className={`w-full md:block md:w-auto  transition-max-h ease-in-out duration-500 mobile:overflow-hidden ${
            isMenuOpen ? "mobile:h-[380px]" : "mobile:h-0 "
          }`}
          id="navbar-default"
        >
          <ul className="flex justify-between  flex-col  mt-5 mobile:gap-y-4 rounded-lg md:flex-row lg:gap-x-14 md:mt-0 md:border-0 ">
