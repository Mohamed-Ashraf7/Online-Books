...
const Tabs = lazy(() => import("../components/TabBtn"));
const Content = () => {
  ...
  return (
    <Fragment>
      <Landing />
      <Section>
        <h2 className="font-second px-5 w-full text-3xl pb-2 mb-2 text-[#333]  font-bold border-b-2 border-black ">
          Every Syllable Is A Spark.”
        </h2>

        <Tabs handle={handleClick} activeTab={activeTab} />
        <div
          className="md:min-w-[500px] w-[350px] bg-center h-[200px] mb-12 -mt-20 p-4 centerd"
          style={{ backgroundImage: `url(${img})` }}
        >
          <div className="flex w-full  shadow-md shadow-gray-700  ">
            <div className="text-gray-700 rounded-tl-md rounded-bl-md w-12 text-center  bg-white p-5">
              <BiSearch size={22} />
            </div>
            <input
              type="text"
              ...
              value={searchQuery}
            />
            <button className="bg-primary rounded-tr-md rounded-br-md py-2 px-5  text-white font-second cursor-pointer hover:bg-blue-800">
              {" "}
              Search
            </button>
          </div>
        ...
        <div className="lg:gap-x-6 gap-x-2 gap-y-16 grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 items-center justify-center">
          {loading === "fulfilled"
