...
const Loader = () => {
  const load = (
    <div
      ...
      <div className="p-6 mt-4 flex items-center justify-between">
        <button  aria-label="more" type="button" className="mobile:px-2 py-2 btn"></button>
        <button type="button"  aria-label="fav"
  ...
  return (
    <div className="w-full h-auto gap-x-5 grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 items-center justify-center">
      {load}
      {load}
