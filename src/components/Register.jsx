      ...
      <form onSubmit={formik.handleSubmit} className="space-y-2">
        <div>
          ...
          {formik.errors.name && formik.touched.name ? (
            <p className="text-red-600 text-sm">{formik.errors.name}</p>) : null}
        </div>
        <div>
          ...
          {formik.errors.email && formik.touched.email ? (
            <p className="text-red-600 text-sm">{formik.errors.email}</p>) : null}
        </div>
        <div>
          ...
          {formik.errors.password && formik.touched.password ? (
            <p className="text-red-600 text-sm">{formik.errors.password}</p> ) : null}
        </div>
        <div>
